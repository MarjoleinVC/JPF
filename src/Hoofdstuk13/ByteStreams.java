...
public class ByteStreams {
    ...
    public static void main(String[] args) {
        ...
        byte[] getallen = {2, 13, 14, 22, 29, 32, 17, 45, 44, 54, 4, 10, 99, 16, 26, 55, 77, 34, 51, 2, 41, 18, 20, 94, 8, 13, 42, 53, 66, 71, 82, 74, 36, 23, 21, 76, 16, 18, 48, 20, 3, 24, 3, 19, 60, 11, 65, 91, 88, 74, 56, 23, 12, 1, 10, 32, 49, 56, 17, 21};
